...
const DashboardIcon: React.FC<Props> = ({className, onClick, fill}) => {
  return (
    <svg width="20" height="20" viewBox="0 0 24 25"  xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} color={fill}>
